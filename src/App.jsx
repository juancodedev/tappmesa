...
// Nueva Landing Page mejorada que mantiene compatibilidad
const EnhancedLandingPage = () => {
  const { appType } = useTenant();
  
  // Si estamos en el dominio principal sin subdominio, mostrar la nueva landing
  if (appType === 'landing' || window.location.hostname === 'tappmesa.local' || window.location.hostname === 'localhost') {
    return <LandingPage />;
  }
  
  // Fallback a la landing original para otros casos
  return (
      ...
      <div className="text-center px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
          <div className="space-y-4">
            <a 
              href="/register"
              className="block w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-red-700 transition-colors touch-target text-center"
            >
              Crear mi local
            </a>
