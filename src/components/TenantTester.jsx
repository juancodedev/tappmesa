    ...
    <div className="p-6">
              ...
              <div className="p-4">
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center space-x-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition-colors text-sm"
                  >
      ...
      {tenants.length === 0 && (
        <div className="text-center py-12">
          ...
          <button
            onClick={loadTenants}
            className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-amber-700 transition-colors"
          >
            Recargar
          </button>
        </div>
