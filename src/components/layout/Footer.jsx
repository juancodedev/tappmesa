...
const Footer = () => {
  ...
  return (
    <footer className="bg-coffee-dark text-white relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-5 gap-8 py-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                ☕
              </div>
              <div>
            ...
            <div>
              <span className="text-white font-semibold mb-4 block flex items-center gap-2">
                <span>🌐</span>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  ...
                  >
                    ...
                    {/* Tooltip */}
                    <div className="absolute bottom-14 left-1/2 transform -translate-x-1/2 bg-coffee-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                      {social.followers}
                    </div>
                  </a>
                ))}
                ...
                {!emailSubmitted ? (
                  <form onSubmit={handleNewsletterSubmit} className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-coffee-700 border border-coffee-600 rounded-lg text-white placeholder-coffee-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all form-input-enhanced"
                      required
                    />
                    <button 
                      type="submit" 
                      className="bg-primary-500 hover:bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold transition-all whitespace-nowrap cta-button hover-lift"
                    >
                      Suscribirse Gratis
                    </button>
                  </form>
      ...
      <button 
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white rounded-full flex items-center justify-center text-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110 z-50 hover-glow"
