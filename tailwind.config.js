...
export default {
  ...
  theme: {
    ...
    // },
      ...
      // Sistema de colores semánticos con variables CSS
      colors: {
    ...
    keyframes: {
      ...
      // Efectos de flotación y movimiento
      "float": {
        "0%, 100%": {
      ...
      // Efectos especiales para cafetería
      "gentle-pulse": {
        "0%, 100%": {
          transform: "scale(1)",
          boxShadow: "0 0 0 0 rgba(184, 149, 106, 0.4)",
      ...
      "steam": {
        ...
        "25%": {
          transform: "translateY(-10px) translateX(2px) scaleX(1.1)",
          opacity: "0.6",
        },
        "50%": {
          transform: "translateY(-20px) translateX(-2px) scaleX(0.9)",
          opacity: "0.4",
        },
        "75%": {
          transform: "translateY(-30px) translateX(1px) scaleX(1.05)",
          opacity: "0.2",
        },
        "100%": {
          transform: "translateY(-40px) translateX(0px) scaleX(1)",
          opacity: "0",
        },
      },
      "coffee-ripple": {
